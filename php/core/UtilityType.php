...
// YesnoGenerator SDK utility type

class YesnoGeneratorUtility
{
    ...
    public static function copy(YesnoGeneratorUtility $src): YesnoGeneratorUtility
    {
        $u = new YesnoGeneratorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
