...
// YesnoGenerator SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = YesnoGeneratorOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(YesnoGeneratorOmni::structfix($now, Struct::undef()))
                        !== json_encode(YesnoGeneratorOmni::structfix($val, Struct::undef()))) {
