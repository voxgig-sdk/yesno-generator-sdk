...
// YesnoGenerator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (YesnoGeneratorSDK::test)
...
{
    private const SDK_CLASS = 'YesnoGeneratorSDK';
    ...
    private const SDK_BASE = 'yesnogenerator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../yesnogenerator_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
