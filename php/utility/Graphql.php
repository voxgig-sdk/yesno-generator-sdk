...
// YesnoGenerator SDK utility: graphql
//
...
class YesnoGeneratorGraphql
{
    ...
    // equivalent.
    public static function body(YesnoGeneratorContext $ctx): mixed
    {
    ...
    public static function errors(YesnoGeneratorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
