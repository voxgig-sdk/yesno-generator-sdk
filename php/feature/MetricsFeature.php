...
// YesnoGenerator SDK metrics feature
...
class YesnoGeneratorMetricsFeature extends YesnoGeneratorBaseFeature
{
    ...
    private function _record(YesnoGeneratorContext $ctx, bool $ok): void
    {
