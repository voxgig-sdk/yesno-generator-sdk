...
// YesnoGenerator SDK timeout feature
...
class YesnoGeneratorTimeoutFeature extends YesnoGeneratorBaseFeature
{
    ...
    private function _with_timeout(YesnoGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(YesnoGeneratorContext $_ctx, float $ms): void
    {
        $client = $this->client;
