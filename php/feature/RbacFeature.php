...
// YesnoGenerator SDK rbac feature
...
class YesnoGeneratorRbacFeature extends YesnoGeneratorBaseFeature
{
    ...
    private function _required(YesnoGeneratorContext $ctx): ?string
    {
    ...
    private function _reject(YesnoGeneratorContext $ctx, string $required): void
    {
    ...
    private function _track(YesnoGeneratorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
