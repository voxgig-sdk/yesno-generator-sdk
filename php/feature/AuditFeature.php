...
// YesnoGenerator SDK audit feature
...
class YesnoGeneratorAuditFeature extends YesnoGeneratorBaseFeature
{
    ...
    private function _emit(YesnoGeneratorContext $ctx, string $outcome): void
    {
