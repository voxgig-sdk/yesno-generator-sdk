...
// YesnoGenerator SDK netsim feature
...
class YesnoGeneratorNetsimFeature extends YesnoGeneratorBaseFeature
{
    ...
    private function _simulate(YesnoGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(YesnoGeneratorContext $ctx, array $applied): void
    {
        $client = $this->client;
