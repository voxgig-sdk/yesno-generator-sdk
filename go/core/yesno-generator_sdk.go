...
func (sdk *YesnoGeneratorSDK) OptionsMap() map[string]any {
...
func (sdk *YesnoGeneratorSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *YesnoGeneratorSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *YesnoGeneratorSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YesnoGeneratorSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *YesnoGeneratorSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *YesnoGeneratorSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("YesnoGeneratorSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *YesnoGeneratorSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YesnoGeneratorSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("YesnoGeneratorSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *YesnoGeneratorSDK {
	...
	sdk := NewYesnoGeneratorSDK(sdkopts)
	sdk.Mode = "test"
