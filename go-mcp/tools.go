...
func registerTools(server *mcp.Server, client *sdk.YesnoGeneratorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "yesno-generator_list",
		Description: "List records from YesnoGenerator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "yesno-generator_load",
		Description: "Load a single record from YesnoGenerator. " +
...
func runOp(client *sdk.YesnoGeneratorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.YesnoGeneratorSDK, name string) (sdk.YesnoGeneratorEntity, error) {
