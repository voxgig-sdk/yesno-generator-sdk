# YesnoGenerator Lua SDK



The Lua SDK for the YesnoGenerator API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/yesno-generator-sdk/releases)),
...
```
lua/
├── yesno-generator_sdk.lua    -- Main SDK module
...
The main module (`yesno-generator_sdk`) exports the SDK constructor
