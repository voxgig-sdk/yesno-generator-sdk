...
function runner.env_override(m)
  local live = runner.getenv("YESNO_GENERATOR_TEST_LIVE")
  local override = runner.getenv("YESNO_GENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("YESNO_GENERATOR_TEST_EXPLAIN")
