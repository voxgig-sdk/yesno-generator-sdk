...
function runner.env_override(m)
  local live = runner.getenv("YESNOGENERATOR_TEST_LIVE")
  local override = runner.getenv("YESNOGENERATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("YESNOGENERATOR_TEST_EXPLAIN")
