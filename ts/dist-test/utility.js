...
function envOverride(m) {
    if ('TRUE' === process.env.YESNO_GENERATOR_TEST_LIVE ||
        'TRUE' === process.env.YESNO_GENERATOR_TEST_OVERRIDE) {
    ...
    m.YESNO_GENERATOR_TEST_EXPLAIN = process.env.YESNO_GENERATOR_TEST_EXPLAIN || m.YESNO_GENERATOR_TEST_EXPLAIN;
    return m;
}
