...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.YESNOGENERATOR_TEST_LIVE ||
    'TRUE' === process.env.YESNOGENERATOR_TEST_OVERRIDE
  ) {
  ...
  m.YESNOGENERATOR_TEST_EXPLAIN = process.env.YESNOGENERATOR_TEST_EXPLAIN || m.YESNOGENERATOR_TEST_EXPLAIN
