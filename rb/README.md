# YesnoGenerator Ruby SDK



The Ruby SDK for the YesnoGenerator API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `YesnoGeneratorError` (a `StandardError` subclass), so wrap
...
```
rb/
├── YesnoGenerator_sdk.rb       -- Main SDK module
