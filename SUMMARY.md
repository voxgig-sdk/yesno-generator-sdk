...
Results: Successful response with yes/no answer.
...
- Production server: `https://yesno.wtf`
...
- `yesno-generator_list`: List records for an entity. No active entity supports this operation.
- `yesno-generator_load`: Load one record for an entity. Supported entities: `api`.
