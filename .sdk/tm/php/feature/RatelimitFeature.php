...
// YesnoGenerator SDK ratelimit feature
...
class YesnoGeneratorRatelimitFeature extends YesnoGeneratorBaseFeature
{
    ...
    private function _acquire(YesnoGeneratorContext $ctx): void
    {
    ...
    private function _track(YesnoGeneratorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
