...
// YesnoGenerator SDK proxy feature
...
class YesnoGeneratorProxyFeature extends YesnoGeneratorBaseFeature
{
    ...
    public function init(YesnoGeneratorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YesnoGeneratorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
