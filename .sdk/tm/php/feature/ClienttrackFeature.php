...
// YesnoGenerator SDK clienttrack feature
...
class YesnoGeneratorClienttrackFeature extends YesnoGeneratorBaseFeature
{
    ...
    public function PostConstruct(YesnoGeneratorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'YesnoGenerator-SDK';
