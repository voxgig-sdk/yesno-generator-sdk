...
// YesnoGenerator SDK cache feature
...
class YesnoGeneratorCacheFeature extends YesnoGeneratorBaseFeature
{
    ...
    private function _through(YesnoGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
