...
// YesnoGenerator SDK utility: make_options

class YesnoGeneratorMakeOptions
{
    ...
    public static function call(YesnoGeneratorContext $ctx): array
    {
        ...
        //
        // `YesnoGeneratorSchema::optspec()` is built from the model:
        ...
        $optspec = YesnoGeneratorSchema::optspec();
