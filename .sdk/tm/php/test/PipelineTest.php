...
// YesnoGenerator SDK pipeline test
//
...
{
    private static function utility(): YesnoGeneratorUtility
    {
        return new YesnoGeneratorUtility();
    }
    ...
    private static function ctx(array $over = []): YesnoGeneratorContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new YesnoGeneratorContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new YesnoGeneratorOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof YesnoGeneratorError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new YesnoGeneratorOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = YesnoGeneratorMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new YesnoGeneratorOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = YesnoGeneratorMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new YesnoGeneratorOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = YesnoGeneratorMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YesnoGeneratorSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = YesnoGeneratorMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = YesnoGeneratorMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new YesnoGeneratorSpec([]),
            'response' => null,
            'result' => new YesnoGeneratorResult([]),
        ]);
        [, $err] = YesnoGeneratorMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new YesnoGeneratorSpec(['step' => 's']),
            'response' => new YesnoGeneratorResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new YesnoGeneratorResult([]),
        ]);
        [, $err] = YesnoGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new YesnoGeneratorSpec(['step' => 's']),
            'response' => new YesnoGeneratorResponse(self::resp(200, ['v' => 1])),
            'result' => new YesnoGeneratorResult([]),
        ]);
        [, $err] = YesnoGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new YesnoGeneratorSpec(['step' => 's']),
            'response' => new YesnoGeneratorResponse(self::resp(200, ['v' => 2])),
            'result' => new YesnoGeneratorResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        YesnoGeneratorMakeResponse::call($ctx);
    ...
    {
        $preset = new YesnoGeneratorResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new YesnoGeneratorSpec([]),
            'response' => new YesnoGeneratorResponse([]),
            'result' => new YesnoGeneratorResult([]),
        ...
        [$got, $err] = YesnoGeneratorMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new YesnoGeneratorResult([])]);
        [, $err] = YesnoGeneratorMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new YesnoGeneratorSpec([]), 'result' => null]);
        [, $err] = YesnoGeneratorMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YesnoGeneratorSpec(['step' => 's']),
            'result' => new YesnoGeneratorResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new YesnoGeneratorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YesnoGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YesnoGeneratorSpec(['step' => 's']),
            'result' => new YesnoGeneratorResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new YesnoGeneratorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YesnoGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YesnoGeneratorResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new YesnoGeneratorSpec([]),
            'result' => new YesnoGeneratorResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = YesnoGeneratorMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YesnoGeneratorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new YesnoGeneratorError('boom', 'boom');
        $utility->fetcher = function (YesnoGeneratorContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YesnoGeneratorSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = YesnoGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (YesnoGeneratorContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = YesnoGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(YesnoGeneratorResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        YesnoGeneratorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (YesnoGeneratorContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YesnoGeneratorSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = YesnoGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new YesnoGeneratorResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new YesnoGeneratorSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = YesnoGeneratorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = YesnoGeneratorMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = YesnoGeneratorMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new YesnoGeneratorResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, YesnoGeneratorDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new YesnoGeneratorResult(['ok' => false])]);
        $this->expectException(YesnoGeneratorError::class);
        YesnoGeneratorDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new YesnoGeneratorResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', YesnoGeneratorMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        YesnoGeneratorMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new YesnoGeneratorBaseFeature();
        $b = new YesnoGeneratorBaseFeature();
        YesnoGeneratorFeatureAdd::call($ctx, $a);
        YesnoGeneratorFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): YesnoGeneratorBaseFeature
    {
        $f = new YesnoGeneratorBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        YesnoGeneratorFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): YesnoGeneratorContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new YesnoGeneratorSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YesnoGeneratorPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        YesnoGeneratorPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new YesnoGeneratorResponse(['headers' => null]),
            'result' => new YesnoGeneratorResult([]),
        ]);
        YesnoGeneratorResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        YesnoGeneratorResultBody::call($ctx);
