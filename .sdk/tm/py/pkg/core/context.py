...
from projectname_sdk.core.control import YesnoGeneratorControl
...
class YesnoGeneratorContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = YesnoGeneratorControl()
        ...
        if isinstance(sp, YesnoGeneratorSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, YesnoGeneratorResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, YesnoGeneratorResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return YesnoGeneratorOperation({})
    ...
    def make_error(self, code, msg):
        return YesnoGeneratorError(code, msg, self)
