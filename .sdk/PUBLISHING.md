...
|---|---|---|
| `ts/` | @voxgig-sdk/yesno-generator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/yesno-generator-sdk \
      --repository voxgig-sdk/yesno-generator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/yesno-generator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/yesno-generator-sdk --id=<id>` removes it.
