...
func registerSDKWords(r *eng.Registry, client *sdk.YesnoGeneratorSDK) {
...
func runOp(client *sdk.YesnoGeneratorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
