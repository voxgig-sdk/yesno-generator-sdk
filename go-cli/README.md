...
AQL-driven CLI and REPL for the YesnoGenerator SDK. Positional arguments are
...
```sh
go build -o yesno-generator-cli ./...
```
...
./yesno-generator-cli list api
./yesno-generator-cli load 1 api
./yesno-generator-cli load '{id:1}' api
