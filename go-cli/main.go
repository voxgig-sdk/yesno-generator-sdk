// Command YesnoGenerator-cli is a CLI + REPL for the YesnoGenerator SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      YESNO_GENERATOR_APIKEY (api key), YESNO_GENERATOR_BASE (base url override)")
