...
class YesnoGeneratorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YesnoGeneratorTestRunner.getenv("YESNOGENERATOR_TEST_LIVE")
        override = YesnoGeneratorTestRunner.getenv("YESNOGENERATOR_TEST_OVERRIDE")
        ...
        explain = YesnoGeneratorTestRunner.getenv("YESNOGENERATOR_TEST_EXPLAIN")
