# YesnoGenerator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions YesnoGeneratorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both YesnoGeneratorSDK(...) and YesnoGeneratorSDK.test(...) become
#      YesnoGeneratorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "yesnogenerator_sdk"
_SDK_CLASS = "YesnoGeneratorSDK"
