# YesnoGenerator Python SDK



The Python SDK for the YesnoGenerator API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/yesno-generator-sdk/releases)) or
...
```python
client = YesnoGeneratorSDK.test(testopts, sdkopts)
```
...
| --- | --- | --- |
| `answer` | `str` | The answer: 'yes' or 'no' |
| `forced` | `bool` | Indicates whether the answer was forced via query parameter |
| `image` | `str` | URL of a GIF image corresponding to the answer |
...
```
py/
├── yesnogenerator_sdk.py         -- Main SDK module
...
The main module (`yesnogenerator_sdk`) exports the SDK class.
