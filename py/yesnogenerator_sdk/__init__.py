...
from yesnogenerator_sdk.utility import register

# Load features
from yesnogenerator_sdk.feature.base_feature import YesnoGeneratorBaseFeature
from yesnogenerator_sdk.features import _has_feature, _make_feature
...
class YesnoGeneratorSDK:
    ...
    def get_utility(self):
        return YesnoGeneratorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("YesnoGeneratorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Api(self, data=None) -> "ApiEntity":
        ...
        from yesnogenerator_sdk.entity.api_entity import ApiEntity
